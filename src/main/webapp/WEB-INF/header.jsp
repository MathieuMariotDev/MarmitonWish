...
<header class="col-12 ">
    <nav id="navHeader" class=" header navbar navbar-expand-lg fixed-top">
        <div class="container ">
            ...
            <img src="https://sauvageboris.fr/training/javaee/recipeEE/resources/logo/60.png">
            ...
            <c:if test="${! empty sessionScope.user}">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/recipes">Voir les recettes</a></li>
                    </ul>
                </div>
            </c:if>
        </div>
